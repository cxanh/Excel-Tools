...
```bash
# 创建存放 Pyodide 资源的目录
mkdir -p public/pyodide/v0.24.1/full

# 下载核心文件
wget -P public/pyodide/v0.24.1/full/ https://cdn.jsdelivr.net/pyodide/v0.24.1/full/pyodide.js
wget -P public/pyodide/v0.24.1/full/ https://cdn.jsdelivr.net/pyodide/v0.24.1/full/pyodide.asm.js
wget -P public/pyodide/v0.24.1/full/ https://cdn.jsdelivr.net/pyodide/v0.24.1/full/pyodide.asm.wasm
wget -P public/pyodide/v0.24.1/full/ https://cdn.jsdelivr.net/pyodide/v0.24.1/full/pyodide_py.tar
```
...
class PyodideManager {
  ...
  private async doLoadPyodide(): Promise<any> {
    try {
      ...
      const indexURL =
        config.loadMode === "local" ? config.localIndexURL : config.cdnIndexURL;
...
```json
{
  ...
  "build": {
    "extraResources": [{ "from": "public/pyodide", "to": "public/pyodide" }]
  }
}
```
...
gzip -9 public/pyodide/v0.24.1/full/pyodide.js
gzip -9 public/pyodide/v0.24.1/full/pyodide.asm.js
gzip -9 public/pyodide/v0.24.1/full/pyodide_py.tar

# 重命名压缩文件
mv public/pyodide/v0.24.1/full/pyodide.js.gz public/pyodide/v0.24.1/full/pyodide.js.br
mv public/pyodide/v0.24.1/full/pyodide.asm.js.gz public/pyodide/v0.24.1/full/pyodide.asm.js.br
mv public/pyodide/v0.24.1/full/pyodide_py.tar.gz public/pyodide/v0.24.1/full/pyodide_py.tar.br
```
