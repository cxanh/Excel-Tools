  ...
  >
    <template #default="{ currentStep }">
      <div v-if="currentStep === 0" class="step-content">
        <a-alert
          message="功能说明"
          description="修改Excel的元数据，更新文档信息。包括作者、标题、主题、关键词等。"
          type="info"
          show-icon
      ...
      <div v-if="currentStep === 1" class="step-content">
        <a-card title="元数据设置" :bordered="false">
          <a-form layout="vertical">
            <a-form-item label="作者">
              <a-input
                v-model:value="metadata.author"
                placeholder="输入作者名称"
              />
            </a-form-item>
            ...
            <a-form-item label="主题">
              <a-input
                v-model:value="metadata.subject"
                placeholder="输入文档主题"
              />
            </a-form-item>
            <a-form-item label="关键词">
              <a-input
                v-model:value="metadata.keywords"
                placeholder="输入关键词"
              />
            </a-form-item>
            <a-form-item label="公司">
              <a-input
                v-model:value="metadata.company"
                placeholder="输入公司名称"
              />
            </a-form-item>
          </a-form>
  ...
  try {
    for (let i = 0; i < files.value.length; i++) {
      ...
      try {
        ...
        const result = await runPythonScript("modify-metadata", {
